...
// Batch 10 frontend page: "No crew scheduling optimization" (ai-gap) — foodTruck
import React, { useEffect, useState } from 'react';

const SLUG = "no-crew-scheduling-optimization";
const LABEL = "No crew scheduling optimization";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-crew-scheduling-optimization";

export default function GapNoCrewSchedulingOptimization() {
