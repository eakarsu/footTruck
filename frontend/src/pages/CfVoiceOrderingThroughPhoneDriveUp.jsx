...
// Batch 10 frontend page: "Voice ordering through phone / drive-up kiosk" (cfs) — foodTruck
import React, { useEffect, useState } from 'react';

const SLUG = "voice-ordering-through-phone-drive-up";
const LABEL = "Voice ordering through phone / drive-up kiosk";
const SECTION = "cfs";
const API_PATH = "/api/cf-voice-ordering-through-phone-drive-up";

export default function CfVoiceOrderingThroughPhoneDriveUp() {
