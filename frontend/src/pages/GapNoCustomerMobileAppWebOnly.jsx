...
// Batch 10 frontend page: "No customer mobile app (web only)" (nonai-gap) — foodTruck
import React, { useEffect, useState } from 'react';

const SLUG = "no-customer-mobile-app-web-only";
const LABEL = "No customer mobile app (web only)";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-customer-mobile-app-web-only";

export default function GapNoCustomerMobileAppWebOnly() {
