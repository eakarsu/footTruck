...
// Batch 10 frontend page: "No supplier-sourcing optimization" (ai-gap) — foodTruck
import React, { useEffect, useState } from 'react';

const SLUG = "no-supplier-sourcing-optimization";
const LABEL = "No supplier-sourcing optimization";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-supplier-sourcing-optimization";

export default function GapNoSupplierSourcingOptimization() {
