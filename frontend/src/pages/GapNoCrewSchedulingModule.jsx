...
// Batch 10 frontend page: "No crew scheduling module" (nonai-gap) — foodTruck
import React, { useEffect, useState } from 'react';

const SLUG = "no-crew-scheduling-module";
const LABEL = "No crew scheduling module";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-crew-scheduling-module";

export default function GapNoCrewSchedulingModule() {
