...
// Batch 10 frontend page: "No voice ordering agent" (ai-gap) — foodTruck
import React, { useEffect, useState } from 'react';

const SLUG = "no-voice-ordering-agent";
const LABEL = "No voice ordering agent";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-voice-ordering-agent";

export default function GapNoVoiceOrderingAgent() {
