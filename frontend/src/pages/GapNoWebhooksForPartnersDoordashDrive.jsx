...
// Batch 10 frontend page: "No webhooks for partners (DoorDash Drive, weather APIs)" (nonai-gap) — foodTruck
import React, { useEffect, useState } from 'react';

const SLUG = "no-webhooks-for-partners-doordash-drive";
const LABEL = "No webhooks for partners (DoorDash Drive, weather APIs)";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-webhooks-for-partners-doordash-drive";

export default function GapNoWebhooksForPartnersDoordashDrive() {
